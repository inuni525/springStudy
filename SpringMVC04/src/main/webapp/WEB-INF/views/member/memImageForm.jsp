...
<div class="container">
  ...
  <div class="panel panel-default">
    ...
    <div class="panel-body">			
    							<!-- 파일업로드시 바이너리데이터를 넘기기 위해 반드시 적어줘야함 -->
      <form action="${contextPath}/memImageUpdate.do" method="post" enctype="multipart/form-data">
         <input type="hidden" name="memID" value="${m.memID}"/><!-- 어떤 회원의 사진인지 알아야하므로 -->
         
         <table class="table table-bordered" style="text-align: center; border: 1px solid #dddddd;">
           <tr>
             <td style="width: 110px; vertical-align: middle;">아이디</td>
             <td>${m.memID}</td><!-- 출력만 해주겠음 -->
           </tr>
           ...
           <tr>
             ...
             <td colspan="2">
               <span class="btn btn-default">
                 이미지를 업로드하세요.<input type="file" name="memProfile"/><!-- 파일첨부 버튼 = 서버에 넘기겠다! -->
               </span>
             </td>            
           </tr>  
