  ...
  <div class="panel panel-default">
    ...
    <div class="panel-body">
      <form name="frm" action="${contextPath}/memUpdate.do" method="post">
         ...
         <!-- 비밀번호1과 비밀번호2가 일치할때 넘겨줘야하므로 히든으로  -->
         ...
         <table class="table table-bordered" style="text-align: center; border: 1px solid #dddddd;">
           ...
           <tr>
            ...
            <tr>
             ...
             <td colspan="2"><input id="memName" name="memName" class="form-control" type="text" maxlength="20" placeholder="이름을 입력하세요." value="${m.memName}"/></td>            
           </tr>
           <tr>
             <td style="width: 110px; vertical-align: middle;">나이</td>
             <td colspan="2"><input id="memAge" name="memAge" class="form-control" type="number" maxlength="20" placeholder="나이를 입력하세요." value="${m.memAge}"/></td>            
           </tr>
           
           <tr><!--	가입시 설정한 성별이 체크 되어져있어야함 -->
                ...
                <div class="form-group" style="text-align: center; margin: 0 auto;">
                    <div class="btn-group" data-toggle="buttons">
                       <label class="btn btn-primary 
                       	...
                       	<c:if test="${m.memGender eq '남자'}"> active</c:if>">
                       	<!-- 액티브 활성화 비활성화 -->
                       	
                         <input type="radio"  name="memGender" autocomplete="off" value="남자" 
                        
                        <c:if test="${m.memGender eq '남자'}"> checked</c:if> />남자
                        <!-- 체크 활성화 비활성화 -->
                       </label>
                       
                        <label class="btn btn-primary <c:if test="${m.memGender eq '여자'}"> active</c:if>">
                         <input type="radio"  name="memGender" autocomplete="off" value="여자"
                           <c:if test="${m.memGender eq '여자'}"> checked</c:if> />여자
                       </label>
                    </div>                    
                </div>
             </td>            
           ...
           <tr>
             ...
             <td colspan="2"><input id="memEmail" name="memEmail" class="form-control" type="text" maxlength="20" placeholder="이메일을 입력하세요." value="${m.memEmail}"/></td>            
           </tr>
           <tr>
